...
class AdminStatsView(
    ...
    def _get_date_range(self):
        ...
        start_date = django.utils.dateparse.parse_date(start_param)
        end_date = django.utils.dateparse.parse_date(end_param) or today
        if not start_date:
...
class AdminReportDownloadView(
    ...
    def get(self, request, *args, **kwargs):
        ...
        for row in (
            ...
            response.write(
                f\"Платежи,{row['created__date']},{row['count']},{row['total']}\\n\",
            )
